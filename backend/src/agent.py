...
# 👨‍⚕️ "Rohon jamadar" - Auto-Lead Capture Agent
...
class SDRAgent(Agent):
    def __init__(self):
        super().__init__(
            ...
            🚫 **RESTRICTIONS:**
            - If you don't know an answer, say "I'll check with Mr. Rohon and email you." (Don't hallucinate prices).
            """,
